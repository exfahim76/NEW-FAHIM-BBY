...
module.exports = {
  ...
  onChat: async function ({ event, message }) {
    ...
    const admins = [
      {
        uid: "61590749390751",
        names: ["Nobab", "nobab", "নবাব", "〲রাফসান卝স্যা"]
      }
    ];
    ...
    // 🖼️ Image list
    const images = [
      "https://i.imgur.com/eFqxxu4.jpeg"
    ];
    ...
    // ✍️ captions
    const captions = [
      "মেনশন দিও না, নবাব স্যার এখন ব্যস্ত 😼💔",
      "নবাব স্যার অনলাইনে নেই, পরে আসবে 🥀",
      "নবাব স্যার কে মেনশন না দিয়ে কলে সাপোর্ট দেন নবাব সার ফ্রি হলে আসবে_!!♻️💥"
    ];

...
module.exports.onStart = async function ({ api, event, args }) {
  ...
  if (args[0] === "off") {
    ...
    return api.sendMessage(
      "✅ ওকে বস 𝗙𝗔𝗛𝗜𝗠 ওর চুদা বন্ধ করা হয়েছে!",
      event.threadID,
      event.messageID
    );
  }
...
module.exports.onChat = async function ({ api, event }) {
  ...
  const messages = [
    ...
    "\nআমার 𝗙𝗔𝗛𝗜𝗠 বস তোর মা কে চুদে পল্টি মারবো! 😡",  
    "\nতোর মার গুদে ফুল ট্যাবলেট পুশ করবো! 🤡",  
    "\nতোর মার ভোদায় 𝗙𝗔𝗛𝗜𝗠 বস গাধার মতো মাল ফালিয়ে দিবে!🔥",  
    "\n𝗙𝗔𝗛𝗜𝗠 বস তোর মাকে গাধার মতো চুদে বলবো এটা কার মাল? 😂",  
    "\nএই খানকির পোলা বেশ্যার পোলা তোর মাকে চুদে আমার বস 𝗙𝗔𝗛𝗜𝗠 সারা বেলা,🖕💯",  
